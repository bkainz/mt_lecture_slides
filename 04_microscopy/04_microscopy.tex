...
\begin{frame}{Light Path in Fluorescence Microscope$^1$}
	...
	\begin{columns}[T,onlytextwidth]
		...
		\begin{column}{0.6\textwidth}
			...
			%	    			\node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=\textwidth]{images/FluorescenceMicroscope}} {};
			%	    			\uncover<2->{
			%	    			\node at (5.2,3.6) {eye};
...
\begin{frame}{Lenses}
	\begin{figure}
		\centering
		%\includegraphics[width=0.51\textwidth,height=0.3\textheight]{cells1bfrep}  
		\includegraphics[width=0.6\textwidth]{images/zeissobjective.jpg}
		\caption{Microscope lens https://zeiss-campus.magnet.fsu.edu/tutorials/basics/objectivecolorcoding/indexflash.html}
		\label{fig:mic:cells1bf}
	\end{figure}
\end{frame}


\begin{frame}{Modern Microscope}
	\begin{figure}
		\centering
		%\includegraphics[width=0.51\textwidth,height=0.3\textheight]{cells1bfrep}  
		\includegraphics[width=0.6\textwidth]{images/modernMicroscope.png}
		\caption{Modern Microscope}
		\label{fig:mic:cells1bf}
	\end{figure}
\end{frame}
