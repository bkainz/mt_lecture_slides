...
\begin{frame}{Computer Assistance (Definition)}
	...
	\begin{myDefinition}
		\textit{Computer Assistance} in minimally invasive procedures allows improved visualization, data overlays or robot guidance to reduce the workload for the surgeon, improve safety or to reduce the operation time. Assistance means that no procedure is performed by computers only, the surgeon always has to keep the responsibility for the entire intervention.
	\end{myDefinition}
\end{frame}
