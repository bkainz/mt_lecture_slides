...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Blackboard Exercise: \tabto{3cm} Mischa Dombrowski, Erik Gösche, Annika Hofmann  
			\item Final Project: \tabto{3cm} Mischa Dombrowski, Erik Gösche, Annika Hofmann  
			\item Homework Tasks: \tabto{3cm} Johanna M\"uller, Jinho Kim
			\item Student Tutors: \tabto{3cm} Peter Jakubec (peter.jakubec@fau.de), Natalia Scherer (natalia.scherer@fau.de), Jiaxin (Cindy) Zhan (jiaxin.zhang@fau.de), Hadis Ganji (hadis.ganji@fau.de)
		\end{itemize}
		\item Contact: \texttt{\url{https://www.studon.fau.de/studon/go/frm/6272122}}
	\end{itemize}
\end{frame}
...
\begin{frame}[c]{Lectures}
	\begin{itemize}
		...
		\item Lecture is in English in H19. German Video recordings are available. 
		...
		\item Monday 08:15 c.t. - 09:45 and Wed 14:15 - 15:45 and on MS TeamsS
		\item MS Teams channel password: \textbf{z2qebxs}
		\item Suggested consumption mode: classroom + hybrid + recordings
		\begin{enumerate}
			\item ask questions in the \href{https://www.studon.fau.de/studon/goto.php?target=frm_4685856}{Forum}
			\item we will discuss each week's content during the lecture slot.
		\end{enumerate}
	\end{itemize}
\end{frame}
...
28.04.23                 & Introduction                   &                      \\
30.04.23                 & System theory 1+2              &                      \\
05.05.23                 & System theory  3+4             &                      \\
07.05.23                 & Image Analysis 1                &                      \\
12.05.23                 & Image Analysis 2                &                      \\
14.05.23                 & Endoskopy, Microscopy 1       &                      \\
19.05.23                 & Microscopy 2       &                      \\
21.05.23                 &  Ultrasound       &                      \\
26.05.23                 &  Ultrasound practical in class (not sure yet)     &                      \\
28.05.23                 & OCT          & \\
02.06.23                 & X-ray 1 (ray generation) + 2 (matter interaction) + 3 (imaging)               &                      \\
04.06.23                 & X-ray 2 (matter interaction) + 3 (imaging)                     &                      \\
09.06.23                 & Whitmonday                     &                      \\
11.06.23                 & CT 1 (basic concepts) + 2 (reconstruction)                          &                      \\
16.06.23                 & CT 3 (resolution, noise, artifacts) + 4 (spectral CT)                          &                      \\
18.06.23                 & magnetic resonance imaging 1 (NMR)       &                      \\
23.06.23                 & magnetic resonance imaging 1 (imaging)       &                      \\
25.06.23                 & Nuclear Medicine  &      \\                
\end{tabular}
}
\end{table}
\end{frame}
...
\textbf{Week 2025} & \textbf{Board Exercise} & \textbf{Sheet Release} & \textbf{Sheet Submission} \\ \hline
18 & --                 & Sheet 1 + Setup: 28.04 & --                    \\
19 & Exercise 1         & --                     & Sheet 1: 11.05        \\
20 & Exercise 2         & Sheet 2: 12.05         & Sheet 2: 18.05        \\
21 & Exercise 3         & Sheet 3: 19.05         & --                    \\
22 & --                 & --                     & Sheet 3: 01.06        \\
23 & Project Exercise   & Sheet 4: 02.06         & --                    \\
24 & Exercise 4         & --                     & Sheet 4: 15.06        \\
25 & --                 & Sheet 5: 16.06         & --                    \\
26 & Exercise 5         & Sheet 6: 23.06         & --                    \\
27 & Exercise 6         & --                     & Sheet 6: 06.07        \\
\end{tabular}
}
		\end{center}
	\end{block}
...
\begin{frame}
	...
	\begin{block}{Blackboard Exercises}
		\begin{itemize}
			...
			\item Thu 14:15 - 15:45, see StudOn schedule, in H8 (Room 11901.00.226, Erwin-Rommel-Straße 60, 91058 Erlangen)
...
\begin{itemize}
    ...
    \item Rooms:
    \begin{itemize}
        \item CIP1 — 11302.01.155 (01.155-113 CIP Pool Informatik)
        \item CIP4 — 11302.00.156 (00.156-113 CIP Pool Informatik)
    \end{itemize}
    \item Schedule (starting from 22.04.2025)
    \begin{itemize}
        \item MON 10:15 -- 11:45 (CIP1)
        \item TUE 08:30 -- 10:00 (CIP1)
        \item TUE 12:15 -- 13:45 (CIP1)
        \item WED 12:15 -- 13:45 (CIP4)
        \item FRI 16:00 -- 17:30 (CIP1)
    \end{itemize}
\end{itemize}
	\end{block}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{enumerate}
			\item Writing of a practical report, work through your algorithm in scientific notation and explain with a practical step-by-step example.
...
\begin{frame}[c]{Plagiarism}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item ...for both!
			\item happended several times in the past. Students have left University. 
		\end{itemize}
		\item Work independently!
		\item ChatGPT etc.: yes for coding and information retrieval, but if you write your final report with it don't expect a mark better than 4.0.
	\end{itemize}
\end{frame}
